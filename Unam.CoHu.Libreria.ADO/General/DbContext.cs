...
namespace Unam.CoHu.Libreria.ADO
{
    ...
    {
        protected string _cnnString = ConfigurationManager.ConnectionStrings["DbConnection"].ConnectionString;        
        ...
        {
            _cnnString = ConfigurationManager.ConnectionStrings[nameCnnConfiguration].ConnectionString;
            this._SQLConexion = new SqlConnection(_cnnString);
        }
