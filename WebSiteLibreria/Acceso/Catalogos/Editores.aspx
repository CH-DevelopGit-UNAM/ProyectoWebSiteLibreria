<%@ Page Title="Editores" Language="C#" MasterPageFile="~/ResponsiveSite.master" AutoEventWireup="true" CodeFile="Editores.aspx.cs" Inherits="Catalogos_Editores"  Theme="SkinBase"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderPlaceHolder" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        var idLabelClaveEditor = '#<%=LabelClaveEditor.ClientID%>';
        ...
        function pageLoad() {
            ...
            $(document).ready(function () {
                configurarGridView(idGridView, function (items, element) {
                    ...
                    var nombre = $(items[2]).find("span").text();
                    setDataModalDetalle(clave, nombre);
                });
        ...
        $(document).ready(function () {            
            ...
            //// Modal-Until-Show...
            $("#DialogoDetalleEditor").on('shown.bs.modal', function (event) {
                var result = validarPanel($("#DialogoDetalleEditor"));
            });

            // Modal-Show
            $("#DialogoDetalleEditor").on('show.bs.modal', function (event) {

                $('#DialogoDetalleEditor').on('hide.bs.modal.prevent', function (event) {
                ...
                $(this).find("input[type='button']").each(function (index, value) {
                    ...
                    if (dataDismiss != null && dataDismiss != undefined) {
                        $(value).click(function (event) {
                            ...
                            cerrarPanel("#DialogoDetalleEditor");
                            $("#DialogoDetalleEditor").off('hide.bs.modal.prevent');
                            $("#DialogoDetalleEditor").modal('hide');
                        });
                    }
                });
        ...
        function showDialogAdd(element) {
            ...
            $("#DialogoDetalleEditor").modal('show');
            return false;
        }
        ...
        function setDataModalDetalle(clave, nombre) {
            $(idHiddenClave).val(clave);
            $(idLabelClaveEditor).text(clave);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h2 class="title-page">Catálogo Editores</h2>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Clave">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabelClave" runat="server" Text='<%#Eval("IdEditor")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Nombre Editor">
                                        <ItemTemplate>
    ...
    <div id="DialogoDetalleEditor" class="modal fade" role="dialog" >
                ...
                <div class="modal-body" style="position:relative; padding: 20px; padding-bottom:8px;">
                    ...
                    <div class="form-horizontal" style="position:relative;" >                        
                        <div class="form-group" style="position:relative;" >
                            ...
                            <div class="col-md-10" >                                
                                <asp:Label ID="LabelClaveEditor" runat="server" CssClass="col-md-2 control-label-left control-Validate" Width="200" data-rule-validation="LabelClaveAutor::1::NA:: :: ::La clave no puede estar vacía"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-10">
                                <asp:TextBox runat="server" ID="TextBoxNombre" CssClass="form-control img-responsive control-Validate" data-rule-validation="TextBoxNombre::1::NA:: :: ::Escriba un nombre"/>
                            </div>
                        </div>
